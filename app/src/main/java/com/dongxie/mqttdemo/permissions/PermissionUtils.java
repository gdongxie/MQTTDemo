package com.dongxie.mqttdemo.permissions;
...
import com.dongxie.mqttdemo.MyApplication;
...
public class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(MyApplication.Companion.getContext().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = MyApplication.Companion.getContext().getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(MyApplication.Companion.getContext(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + MyApplication.Companion.getContext().getPackageName()));
        MyApplication.Companion.getContext().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(MyApplication.Companion.getContext());
    }
